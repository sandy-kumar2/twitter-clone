...
const LeftSidebar = () => {
  ...
  return (
    <div className='w-[20%] p-4'>
      <div>
        <div>
          <img className='ml-5' width={"24px"} src="/twitterlogo.png" alt="twitter-logo" />
        </div>
        <div className='my-4'>
          ...
          <Link to="/followers" className='flex items-center my-2 px-4 py-2 hover:bg-gray-200 hover:cursor-pointer rounded-full'>
            <div>
              <CiUser size="24px"/>
            </div>
            <h1 className='font-bold text-lg ml-2'>Followers</h1>
          </Link>
